...
\plot{regularization/spline-diffsupp-force}{The forcing function evaluated on the central $z$-axis for different orders of Cardinal B-Spline forcing functions}
...
\plot{regularization/spline-diffsupp-velocity}{The $u_3$-component of $\mathbf{u}$ along the central $z$-axis for different orders of Cardinal B-Spline forcing functions, keeping the support proportional to the order.}
